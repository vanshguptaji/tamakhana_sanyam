...
//   return (
//     <>
//       <div className="h-[800px] bg-[#a19f94]"></div>
      
//       <div className="relative bg-[#0f0f0f] py-8 overflow-hidden w-full">
//         <div 
//           ref={containerRef}
//           className="marquee-container flex w-fit whitespace-nowrap"
//         >
//           {Array(9).fill().map((_, index) => (
//             <div key={index} className="marquee-part flex items-center flex-shrink-0 px-1 mx-4 text-gray-100 font-semibold text-4xl uppercase">
//               TamaKhana
//               <div 
//                 ref={setArrowRef}
